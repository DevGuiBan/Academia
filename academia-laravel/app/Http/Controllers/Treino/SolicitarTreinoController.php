...
class SolicitarTreinoController extends Controller
{
    public function store(Request $request,int $id){
        ...
        return redirect()->route('alunos.treino')->with('success', 'Solicitação realizada com sucesso!');
    }
    ...
    public function destroy($id)
    {
        ...
        if (!$solicitacao) {
            return redirect()->route('personal.treino')->with('error', 'Solicitação de treino não encontrado.');
        }
