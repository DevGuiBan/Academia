...
<head>
    ...
    <!-- Adicionar o favicon -->
    <link rel="icon" href="../img/login-icon.svg">
    <title>Login</title>
    <!-- Adicionar o font -->
...
<body>
    <main class="flex justify-center items-center min-h-screen">
        <div class="flex flex-col items-center w-full max-w-md border border-gray-500 p-6" style="height: 80vh;">
            ...
            <button class="bg-[#212529] py-2 px-4 rounded mt-4 w-full border border-[#CCFF33] cursor-pointer text-[#CCFF33]">Criar Conta</button>
        </div>
    </main>
</body>
</html>
