...
<div class="sidebar">
    ...
    <a href={{route('personal.training')}} class="flex flex-row mt-[-60] {{ Request::routeIs('personal.training') ? 'active' : '' }}">
    ...
    <a href={{url('/personal/time')}} class="flex flex-row {{ Request::is('personal/time') ? 'active' : '' }}">
    ...
    <a href={{route('personal.exercises',session('user_id'))}} class="flex flex-row {{ Request::routeIs('personal.exercises') ? 'active' : '' }}">
    ...
    <a href={{route('personal.students',['id_personal'=>session('user_id')])}} class="flex flex-row {{ Request::routeIs('personal.students') ? 'active' : '' }}">
