...
<div class="sidebar">
    ...
    <a href={{url('/horario')}} class="flex flex-row {{ Request::is('personal/horario') ? 'active' : '' }}">
    ...
    <a href={{url('/personal/alunos')}} class="flex flex-row {{ Request::is('personal/alunos') ? 'active' : '' }}">
