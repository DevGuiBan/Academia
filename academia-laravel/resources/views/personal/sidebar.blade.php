...
<div class="sidebar">
    ...
    <a href={{url('/horario')}} class="flex flex-row {{ Request::is('horario') ? 'active' : '' }}">
    ...
    <a href={{url('/exercicio')}} class="flex flex-row {{ Request::is('exercicio') ? 'active' : '' }}">
    ...
    <a href={{url('/alunos')}} class="flex flex-row {{ Request::is('alunos') ? 'active' : '' }}">
