...
<div class="flex flex-col space w-full">
    <div class="flex flex-row ">
        <a href="#" style="margin-left: 80%;">
            <svg viewBox="0 0 16 16" class="bell {{ session('nova_notificacao') ? 'bg-yellow-500' : '' }}" fill="none" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href={{ route('personal.profile', session('user_id')) }} class="ml-[4rem] mt-[-5]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#CCFF33" width="50" height="50" viewBox="0 0 24 24">
    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-col rounded card">
            <a href={{route('personal.salvarTreino',$solicitacao->treino->id)}}>
                <h1>{{ $solicitacao->treino->musculo }}</h1>
                <br>
